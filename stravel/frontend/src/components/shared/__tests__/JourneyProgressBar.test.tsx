...
describe('JourneyProgressBar', () => {
  it('renders nothing when hasStarted is false', () => {
    const { container } = render(
      <JourneyProgressBar stage="idle" hasStarted={false} onStageClick={vi.fn()} />
    );
  ...
  it('renders outer container when hasStarted is true', () => {
    render(
      <JourneyProgressBar stage="profiling" hasStarted={true} onStageClick={vi.fn()} />
    );
  ...
  it('current stage has bold font weight', () => {
    render(
      <JourneyProgressBar stage="calculating" hasStarted={true} onStageClick={vi.fn()} />
    );
  ...
  it('completed stages do not have teal color (muted)', () => {
    render(
      <JourneyProgressBar stage="proposing" hasStarted={true} onStageClick={vi.fn()} />
    );
  ...
  it('calls onStageClick with correct stage when a completed stage is clicked', () => {
    ...
    render(
      <JourneyProgressBar stage="proposing" hasStarted={true} onStageClick={onStageClick} />
    );
  ...
  it('calls onStageClick for second completed stage', () => {
    const onStageClick = vi.fn();
    render(
      <JourneyProgressBar stage="validating" hasStarted={true} onStageClick={onStageClick} />
    );
  ...
  it('does not call onStageClick when current stage button is clicked (disabled)', () => {
    const onStageClick = vi.fn();
    render(
      <JourneyProgressBar stage="profiling" hasStarted={true} onStageClick={onStageClick} />
    );
    fireEvent.click(screen.getByTestId('stage-step-profiling'));
